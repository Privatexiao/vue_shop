    ...
    <el-card class="box-card">
      ...
      >
        ...
        <template v-slot:isLev="slotIsLev">
          ...
          <el-tag type="success" v-if="slotIsLev.row.cat_level === 1">二级</el-tag>
          <el-tag type="warning" v-if="slotIsLev.row.cat_level === 2">三级</el-tag>
        </template>
        <!-- 操作 -->
        <template v-slot:isCz="slotIsCz">
          <el-button type="primary" icon="el-icon-edit" size="mini">bj</el-button>
