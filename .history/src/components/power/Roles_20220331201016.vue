  ...
  <div>
      ...
      <el-table :data="RolesList" border style="width: 100%" stripe>
        ...
        <el-table-column prop="level" label="操作" width="330">
          <template v-slot:default="slotRolesList">
            ...
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeUserById(slotEditDialog.row.id)
              >删除</el-button
            >
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editUserInfo(editForm.roleId)">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
